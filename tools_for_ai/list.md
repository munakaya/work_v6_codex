...
- market_data_runtime_ws_first_cases.py: market data runtime이 upbit/coinone은 WS 우선, bithumb/sample은 REST 유지, WS 실패 시 REST fallback과 runtime 진단값 노출을 수행하는지 검증한다
