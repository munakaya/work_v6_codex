...
- private_http_adapter_cases.py: private_http adapter를 runtime guard 없이 직접 호출해 existing order id 충돌, submitted-with-fill, submit_failed bad fill, filled bad preview, filled partial, extra fill leg 무저장 fail-closed를 검증한다
