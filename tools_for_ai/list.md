...
- recovery_runtime_cases.py: recovery trace가 zero-exposure/terminal/unwind fill/reconciliation matched면 resolved, failed or stale unwind와 오래 지속된 trace는 handoff_required로 바뀌는지 Redis 기준으로 검증한다
