...
- arbitrage_simulation_cases.py: sim observer용 거래소 쌍 정규화, pair timing gate 보정, skew diagnostic-only 모드, reservation blocked/zero-profit 진단, 양방향 재정거래 평가, reason_code breakdown 포함 누적 집계가 올바른지 검증한다
