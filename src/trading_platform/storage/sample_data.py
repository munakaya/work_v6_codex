            ...
            },
            {
                ...
                "config_json": {
                    ...
                    "arbitrage_runtime": {
                        ...
                        "base_balance": {
                            "available_base": "12",
                            "available_quote": "8000000",
                            "is_fresh": True,
                        },
                        "hedge_balance": {
                            "available_base": "8",
                            "available_quote": "9000000",
                            "is_fresh": True,
                        },
                        "risk_config": {
                            "min_profit_quote": "800",
                            "min_profit_bps": "1.0",
                            "max_clock_skew_ms": 1000,
                            "max_orderbook_age_ms": 3000,
                            "max_balance_age_ms": 10000,
                            "max_notional_per_order": "450000",
                            "max_total_notional_per_bot": "1800000",
                            "max_spread_bps": "50",
                            "slippage_buffer_bps": "1",
                            "unwind_buffer_quote": "0",
                            "taker_fee_bps_buy": "5",
                        ...
                        "runtime_state": {
                            "open_order_cap": 4,
                            "remaining_bot_notional": "1800000",
                        },
                    },
                },
    ...
    fills = [
        {
            ...
            "strategy_run_id": strategy_run_2["run_id"],
            "exchange_name": "upbit",
            "exchange_trade_id": "upbit-fill-001",
            "market": "ETH-KRW",
            "side": "sell",
            "fill_price": "4273000",
            "fill_qty": "0.10",
        ...
        },
        {
            ...
            "strategy_run_id": strategy_run_2["run_id"],
            "exchange_name": "upbit",
            "exchange_trade_id": "upbit-fill-002",
            "market": "ETH-KRW",
            "side": "sell",
            "fill_price": "4272000",
            "fill_qty": "0.07",
        ...
        },
        {
            ...
            "strategy_run_id": strategy_run_1["run_id"],
            "exchange_name": "bithumb",
            "exchange_trade_id": "bithumb-fill-001",
            "market": "BTC-KRW",
            "side": "buy",
            "fill_price": "98318000",
            "fill_qty": "0.010",
